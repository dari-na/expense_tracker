                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            AppLocalizations.of(context)?.remaining(remainingAmount.toStringAsFixed(2)) ?? 'Remaining €${remainingAmount.toStringAsFixed(2)}',
                            style: TextStyle(
                              fontSize: 14,
                          ...
                          SizedBox(height: 5),
                          Text(
                            AppLocalizations.of(context)?.out_of(spentAmount.toStringAsFixed(2), totalAmount.toStringAsFixed(2)) ??
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          AppLocalizations.of(context)?.per_week ?? 'per week',
                          style: TextStyle(
                            fontSize: 14,
                            color: Colors.grey[600],
                          ),
